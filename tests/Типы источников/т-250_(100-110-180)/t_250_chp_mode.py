...
from custom_modules.result_proccessing import get_dataframe_by_output_bus_all, get_dataframe_by_input_bus_all
...
# print(power_loads)
power_loads = 250
hw_loads = power_loads * 1.6767
el_sink = Generic_sinks(es).create_sink_absolute_demand('электричество_потребитель', el_bus, demand_absolute_data= power_loads)
hw_sink = Generic_sinks(es).create_sink_absolute_demand('гвс_потребитель', hw_bus, demand_absolute_data= hw_loads)
